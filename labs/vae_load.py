...
def main():
    ...
    ffl3d = FFL3d(loss_weight=1.0, alpha=1.0)
    ffl3d.to(device)
    ...
    if args.resume_from_checkpoint:
        if path is None:
            ...
            global_step = autoencoder_ckpt["global_step"] + 1
    ...
    while global_step < args.num_train_steps:
        ...
        autoencoderkl.train()
        discriminator.train()
        loss_g_recon, loss_g_kl, loss_g_percep, loss_g_ffl3d, loss_g_total, gen_loss, disc_loss = 0, 0, 0, 0, 0, 0, 0
        ...
        for step, batch in progress_bar:
            ...
            ffl3d_loss = ffl3d(reconstruction.float().unsqueeze(dim=1), images.float().unsqueeze(dim=1))
            loss_g = recons_loss + kl_weight * kl_loss + perceptual_weight * p_loss + ffl3d_weight * ffl3d_loss
            ...
            if global_step % args.checkpointing_steps == (args.checkpointing_steps - 1):
                ...
                if args.report_to == "wandb":
                    wandb.log({
                        ...
                        "train_ffl3d_loss": loss_g_ffl3d / (step + 1),
